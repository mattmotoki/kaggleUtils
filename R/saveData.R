...
#' 
#' The function saves the desired data in the 
#' \code{"C:/Dropbox/Kaggle/Instacart/data"} directory.  
...
#' 
#' @param folder Folder within \code{"C:/Dropbox/Kaggle/Mercedes/Data"} to save
